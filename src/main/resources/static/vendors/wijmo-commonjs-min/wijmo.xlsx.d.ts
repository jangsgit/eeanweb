...
import * as selfModule from 'wijmo/wijmo.xlsx';
/**
...
export declare class _xlsx {
    ...
    static saveAsync(workbook: IWorkbook, cs: _ICancellationSource, onError?: (reason?: any) => any, onProgress?: (value: number) => void): selfModule._SyncPromise;
