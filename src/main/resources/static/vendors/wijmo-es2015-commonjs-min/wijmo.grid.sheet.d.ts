...
import { Row, Column, CellRange, GridPanel, FlexGrid, DataMap, CellRangeEventArgs, HitTestInfo, CellFactory, CellType, _SelectionHandler, SelMove, RowColCollection, RowCollection, ColumnCollection, SelectedState } from 'wijmo/wijmo.grid';
...
import { HtmlEntityConversion } from 'wijmo/wijmo.grid.xlsx';
import * as mInput from 'wijmo/wijmo.input';
import * as mXlsx from 'wijmo/wijmo.xlsx';
import * as selfModule from 'wijmo/wijmo.grid.sheet';
...
export declare class FlexSheet extends FlexGrid {
     ...
     */
    readonly selectedSheetChanged: Event<selfModule.FlexSheet, PropertyChangedEventArgs>;
    /**
     ...
     */
    readonly draggingRowColumn: Event<selfModule.FlexSheet, selfModule.DraggingRowColumnEventArgs>;
    /**
     ...
     */
    readonly droppingRowColumn: Event<selfModule.FlexSheet, EventArgs>;
    /**
     ...
     */
    readonly beginDroppingRowColumn: Event<selfModule.FlexSheet, selfModule.DroppingRowColumnEventArgs>;
    /**
     ...
     */
    readonly endDroppingRowColumn: Event<selfModule.FlexSheet, CancelEventArgs>;
    /**
     ...
     */
    readonly loaded: Event<selfModule.FlexSheet, EventArgs>;
    /**
     ...
     */
    readonly unknownFunction: Event<selfModule.FlexSheet, selfModule.UnknownFunctionEventArgs>;
    /**
     ...
     */
    readonly sheetCleared: Event<selfModule.FlexSheet, EventArgs>;
    /**
     ...
     */
    readonly prepareChangingRow: Event<selfModule.FlexSheet, selfModule.RowColumnChangedEventArgs>;
    /**
     ...
     */
    readonly prepareChangingColumn: Event<selfModule.FlexSheet, selfModule.RowColumnChangedEventArgs>;
    /**
     ...
     */
    readonly rowChanged: Event<selfModule.FlexSheet, selfModule.RowColumnChangedEventArgs>;
    /**
     ...
     */
    readonly columnChanged: Event<selfModule.FlexSheet, selfModule.RowColumnChangedEventArgs>;
    /**
     ...
     */
    readonly autoFilling: Event<selfModule.FlexSheet, selfModule.AutoFillingEventArgs>;
    /**
     ...
     */
    readonly autoFilled: Event<selfModule.FlexSheet, selfModule.AutoFilledEventArgs>;
    /**
...
export declare class UndoStack {
     ...
     */
    readonly undoStackChanged: Event<selfModule.UndoStack, EventArgs>;
    /**
...
export declare class _SmartTag extends Control {
    ...
    dispose(): void;
    readonly operation: AutoFillOperation;
    readonly operationSelected: Event<selfModule._SmartTag, EventArgs>;
    onOperationSelected(e?: EventArgs): void;
    readonly cancelled: Event<selfModule._SmartTag, EventArgs>;
...
export declare class Sheet {
    ...
    _owner: FlexSheet;
    private _visible;
    _unboundSortDesc: ObservableArray<selfModule._UnboundSortDescription>;
     ...
     */
    readonly nameChanged: Event<selfModule.Sheet, PropertyChangedEventArgs>;
    /**
     ...
     */
    readonly visibleChanged: Event<selfModule.Sheet, EventArgs>;
    /**
...
export declare class SheetCollection<T extends Sheet = Sheet> extends ObservableArray<T> {
     ...
     */
    readonly sheetCleared: Event<selfModule.SheetCollection<selfModule.Sheet>, EventArgs>;
    /**
     * Raises the sheetCleared event.
     */
    onSheetCleared(): void;
     ...
     */
    readonly selectedSheetChanged: Event<selfModule.SheetCollection<selfModule.Sheet>, EventArgs>;
    /**
     ...
     */
    readonly sheetNameChanged: Event<selfModule.SheetCollection<selfModule.Sheet>, NotifyCollectionChangedEventArgs<any>>;
    /**
     ...
     */
    readonly sheetVisibleChanged: Event<selfModule.SheetCollection<selfModule.Sheet>, NotifyCollectionChangedEventArgs<any>>;
    /**
...
export declare class _CalcEngine {
    ...
    private _sheet;
    constructor(owner: FlexSheet);
    readonly unknownFunction: Event<selfModule._CalcEngine, selfModule.UnknownFunctionEventArgs>;
    ...
    _parse(expression: string | number): _Expression;
