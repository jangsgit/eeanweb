...
import { Point, Size, Rect, DataType, Event, EventArgs, ICollectionView, ObservableArray, Control, Tooltip, CancelEventArgs } from 'wijmo/wijmo';
import * as selfModule from 'wijmo/wijmo.chart';
...
export declare class FlexChartBase extends Control implements _IPalette {
     ...
     */
    readonly rendering: Event<selfModule.FlexChartBase, selfModule.RenderEventArgs>;
    /**
     ...
     */
    readonly rendered: Event<selfModule.FlexChartBase, selfModule.RenderEventArgs>;
    /**
     ...
     */
    readonly itemsSourceChanging: Event<selfModule.FlexChartBase, CancelEventArgs>;
    /**
     ...
     */
    readonly itemsSourceChanged: Event<selfModule.FlexChartBase, EventArgs>;
    /**
     ...
     * selection.
     */
    readonly selectionChanged: Event<selfModule.FlexChartBase, EventArgs>;
    /**
...
export declare class DataLabelBase {
     ...
     */
    readonly rendering: Event<selfModule.DataLabel, selfModule.DataLabelRenderEventArgs>;
    /**
     * Raises the {@link rendering} event.
     *
...
export declare class Axis implements _IAxis {
    ...
    */
     ...
     */
    readonly rangeChanged: Event<selfModule.Axis, EventArgs>;
    /**
...
export declare class SeriesBase implements _ISeries {
     ...
     */
    readonly rendering: Event<selfModule.SeriesBase, selfModule.SeriesRenderingEventArgs>;
    /**
     * Raises the {@link rendering} event.
     *
     ...
     */
    readonly rendered: Event<selfModule.SeriesBase, selfModule.RenderEventArgs>;
    /**
     * Raises the {@link rendered} event.
     *
     * @param engine The {@link IRenderEngine} object used to render the series.
...
export declare class FlexChartCore extends FlexChartBase {
    ...
    private _symbolSize;
    _dataInfo: selfModule._DataInfo;
    _plotRect: Rect;
    ...
    */
    readonly seriesVisibilityChanged: Event<selfModule.FlexChartCore, selfModule.SeriesEventArgs>;
    /**
...
export declare class LineMarker {
     ...
     */
    readonly positionChanged: Event<selfModule.LineMarker, Point>;
    /**
