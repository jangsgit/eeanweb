...
import { Color, EventArgs, Point, Event, Size, Rect } from 'wijmo/wijmo';
import * as pdfSecurity from 'wijmo/wijmo.pdf.security';
...
*/
export declare enum PdfTextBaseline {
    /**
...
*/
export declare enum PdfTagType {
    /**
...
*/
export declare enum PdfArtifactType {
...
*/
export declare enum PdfPageEdge {
 ...
 */
export interface IPdfArtifactOptions {
    /**
 ...
 */
export interface IPdfTagContentOptions {
    /**
...
*/
export interface IPdfTagOptions {
    /**
...
export declare function _asPdfBrush(value: PdfBrush | Color | string, nullOK?: boolean): PdfBrush;
...
export declare class PdfRunningTitleDeclarativeContent {
    ...
    */
    constructor(text?: string, font?: PdfFont, brush?: PdfBrush | Color | string);
    /**
...
export declare class PdfDocument extends PdfPageArea {
    ...
    * @return The {@link PdfDocument} object.
    */
    setBrush(brush: PdfBrush | Color | string): PdfDocument;
    /**
    ...
    * @return The {@link PdfDocument} object.
    */
    setPen(pen: PdfPen | Color | string): PdfDocument;
    /**
...
export declare class PdfPaths {
    ...
    * @return The {@link PdfPaths} object.
    */
    fill(brush?: PdfBrush | Color | string, rule?: PdfFillRule): PdfPaths;
    /**
    ...
    * @return The {@link PdfPaths} object.
    */
    fillAndStroke(brush?: PdfBrush | Color | string, pen?: PdfPen | Color | string, rule?: PdfFillRule): PdfPaths;
    /**
    ...
    * @return The {@link PdfPaths} object.
    */
    stroke(pen?: PdfPen | Color | string): PdfPaths;
