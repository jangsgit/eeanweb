...
import { ObservableArray, Event, EventArgs, CollectionView, DataType, SortDescription, CancelEventArgs, RequestErrorEventArgs, PageChangingEventArgs } from 'wijmo/wijmo';
import { FlexGridFilter, ConditionFilter, FilterCondition, ValueFilter, Operator } from 'wijmo/wijmo.grid.filter';
import * as wjcGridFilter from 'wijmo/wijmo.grid.filter';
import * as selfModule from 'wijmo/wijmo.cloud';
/**
 ...
 *
 * ```typescript
 * import { OAuth2 } from 'wijmo/wijmo.cloud';
 *
...
export declare class OAuth2 {
     ...
     */
    readonly userChanged: Event<selfModule.OAuth2, EventArgs>;
    /**
     ...
     */
    readonly error: Event<selfModule.OAuth2, selfModule.OAuthError>;
    /**
...
export declare class Snapshot extends CollectionView {
     ...
     */
    readonly loading: Event<selfModule.Snapshot, CancelEventArgs>;
    /**
     ...
     */
    readonly loaded: Event<selfModule.Snapshot, EventArgs>;
    /**
     ...
     */
    readonly error: Event<selfModule.Snapshot, selfModule.FirestoreErrorEventArgs>;
    /**
     * Raises the {@link error} event.
     *
     ...
     * See also the {@link deferCommits} property.
     */
    readonly hasPendingChangesChanged: Event<selfModule.Snapshot, EventArgs>;
    /**
 ...
 *
 * ```typescript
 * import { GoogleSheet, Sheet } from 'wijmo/wijmo.cloud';
 *
 ...
 * ```typescript
 * import { GoogleSheet, Sheet } from 'wijmo/wijmo.cloud';
 * import { FlexGrid } from 'wijmo/wijmo.cloud';
 *
 * // create a GoogleSheet with three Sheets
 * const SHEET_ID_NW = '1qnf-FCONZj_AmOlyNkpIA3mKvP8FQtVOr7K8Awpo360';
 * const API_KEY = 'AIzaSyCvuXEzP57I5CQ9ifZDG2_K8M3nDa1LOPE';
...
export declare class Sheet extends CollectionView {
     ...
     */
    readonly loading: Event<selfModule.Sheet, CancelEventArgs>;
    /**
     * Raises the {@link loading} event.
     ...
     */
    readonly loaded: Event<selfModule.Sheet, EventArgs>;
    /**
     * Raises the {@link loaded} event.
     */
    onLoaded(e?: EventArgs): void;
     ...
     * Occurs when there is an error reading or writing data.
     */
    readonly error: Event<selfModule.Sheet, RequestErrorEventArgs>;
    /**
     * Raises the {@link error} event.
     *
     * By default, errors throw exceptions and trigger a data refresh. If you
 ...
 *
 * ```typescript
 * import { GoogleSheet } from 'wijmo/wijmo.cloud';
 * const SHEET_ID_NW = '1qnf-FCONZj_AmOlyNkpIA3mKvP8FQtVOr7K8Awpo360';
 * const API_KEY = 'AIzaSyCvuXEzP57I5CQ9ifZDG2_K8M3nDa1LOPE';
 * let gsNWind = new GoogleSheet(SHEET_ID_NW, API_KEY, {
 *     sheets: [ 'Products', 'Categories', 'Suppliers' ]
...
export declare class GoogleSheet {
    ...
    _apiKey: string;
    _loading: boolean;
    _sheets: ObservableArray<selfModule.Sheet>;
    _reqSheets: string[];
     ...
     * import { GoogleSheet } from 'wijmo/google';
     ...
     */
    getSheet(title: string): selfModule.Sheet;
    /**
     ...
     */
    readonly loading: Event<selfModule.GoogleSheet, EventArgs>;
    /**
     * Raises the {@link loading} event.
     */
     ...
     */
    readonly loaded: Event<selfModule.GoogleSheet, EventArgs>;
    /**
     * Raises the {@link loaded} event.
     */
    onLoaded(e?: EventArgs): void;
     ...
     * Occurs when there is an error reading or writing data.
     */
    readonly error: Event<selfModule.GoogleSheet, RequestErrorEventArgs>;
    /**
     * Raises the {@link error} event.
     *
     * By default, errors throw exceptions and trigger a data refresh. If you
     ...
     */
    readonly accessTokenChanged: Event<selfModule.GoogleSheet, EventArgs>;
    /**
 ...
 *
 * ```typescript
 * import { Firestore } from 'wijmo/wijmo.cloud';
...
export declare class Firestore {
    _projectId: string;
    _collections: ObservableArray<selfModule.Collection>;
    _accessToken: string;
    _idToken: string;
    _fbToken: string;
    _apiKey: string;
     ...
     */
    getCollection(name: string): selfModule.Collection;
    /**
     * Occurs when the value of the {@link accessToken} property changes.
     */
    readonly accessTokenChanged: Event<selfModule.Firestore, EventArgs>;
    /**
     * Raises the {@link accessTokenChanged} event.
     */
    onAccessTokenChanged(e?: EventArgs): void;
 ...
 *
 * ```typescript
 * import { Firestore, Collection } from 'wijmo/wijmo.cloud';
 *
...
export declare class Collection extends CollectionView {
     ...
     */
    readonly loading: Event<selfModule.Collection, CancelEventArgs>;
    /**
     * Raises the {@link loading} event.
     */
    onLoading(e: CancelEventArgs): boolean;
     ...
     */
    readonly loaded: Event<selfModule.Collection, EventArgs>;
    /**
     * Raises the {@link loaded} event.
     */
    onLoaded(e?: EventArgs): void;
     ...
     * Occurs when there is an error reading or writing data.
     */
    readonly error: Event<selfModule.Collection, RequestErrorEventArgs>;
    /**
     * Raises the {@link error} event.
     *
     * By default, errors throw exceptions and trigger a data refresh. If you
     ...
     * See also the {@link deferCommits} property.
     */
    readonly hasPendingChangesChanged: Event<selfModule.Collection, EventArgs>;
    /**
     * Raises the {@link hasPendingChangesChanged} event.
     */
    onHasPendingChangesChanged(e?: EventArgs): void;
