...
import { FlexChartBase } from 'wijmo/wijmo.chart';
import * as mFinancial from 'wijmo/wijmo.chart.finance';
import * as mRadar from 'wijmo/wijmo.chart.radar';
import * as selfModule from 'wijmo/wijmo.chart.animation';
...
export declare class ChartAnimation {
     ...
     */
    readonly ended: Event<selfModule.ChartAnimation, EventArgs>;
    /**
