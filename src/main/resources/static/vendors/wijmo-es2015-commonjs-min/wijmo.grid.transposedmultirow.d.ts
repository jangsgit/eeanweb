...
import { EventArgs, ICollectionView } from 'wijmo/wijmo';
import { MergeManager, GridPanel, CellRange, Column, Row, AllowDragging, AllowSorting, ColumnCollection, CellRangeEventArgs, FlexGrid } from 'wijmo/wijmo.grid';
import * as selfModule from 'wijmo/wijmo.grid.transposedmultirow';
/**
...
export declare class _MultiRowLayout {
    ...
    _getGroupByRow(r: number): selfModule._CellGroup;
