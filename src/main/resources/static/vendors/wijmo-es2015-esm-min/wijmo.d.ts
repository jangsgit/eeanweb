...
import * as selfModule from 'wijmo/wijmo';
...
export declare class Event<S = any, T = EventArgs> {
     ...
     */
    raise(sender: any, args?: selfModule.EventArgs): void;
    /**
...
export declare class EventArgs {
     ...
     */
    static empty: selfModule.EventArgs;
}
/**
...
export declare class NotifyCollectionChangedEventArgs<T = any> extends EventArgs {
     ...
     */
    static reset: selfModule.NotifyCollectionChangedEventArgs<any>;
    /**
     ...
     */
    constructor(action?: selfModule.NotifyCollectionChangedAction, item?: T, index?: number);
}
/**
...
export declare class ObservableArray<T = any> extends ArrayBase<T> implements INotifyCollectionChanged {
     ...
     * Occurs when the collection changes.
     */
    readonly collectionChanged: selfModule.Event<selfModule.ObservableArray<T>, selfModule.NotifyCollectionChangedEventArgs<T>>;
    /**
     * Raises the {@link collectionChanged} event.
     *
     * @param e Contains a description of the change.
     */
    onCollectionChanged(e?: selfModule.NotifyCollectionChangedEventArgs<any>): void;
...
export declare class CollectionView<T = any> implements IEditableCollectionView, IPagedCollectionView {
    ...
    _idx: number;
    _filter: IPredicate;
    _filters: selfModule.ObservableArray<selfModule.IPredicate<any>>;
    _srtDsc: selfModule.ObservableArray<selfModule.SortDescription>;
    _grpDesc: selfModule.ObservableArray<selfModule.GroupDescription>;
    _newItem: T | null;
    _edtItem: T | null;
    _edtClone: any;
    _committing: boolean;
    ...
    _chgAdded: selfModule.ObservableArray<T>;
    _chgRemoved: selfModule.ObservableArray<T>;
    _chgEdited: selfModule.ObservableArray<T>;
     ...
     * Occurs when the collection changes.
     */
    readonly collectionChanged: selfModule.Event<selfModule.ICollectionView<T>, selfModule.NotifyCollectionChangedEventArgs<T>>;
    /**
     * Raises the {@link collectionChanged} event.
     *
     * @param e Contains a description of the change.
     */
    onCollectionChanged(e?: selfModule.NotifyCollectionChangedEventArgs<any>): void;
    protected _raiseCollectionChanged(action?: selfModule.NotifyCollectionChangedAction, item?: T, index?: number): void;
    /**
     * Occurs before the value of the {@link sourceCollection} property changes.
     */
    readonly sourceCollectionChanging: selfModule.Event<selfModule.ICollectionView<T>, selfModule.CancelEventArgs>;
    /**
     ...
     */
    readonly sourceCollectionChanged: selfModule.Event<selfModule.ICollectionView<T>, selfModule.EventArgs>;
    /**
     ...
     * Occurs after the current item changes.
     */
    readonly currentChanged: selfModule.Event<selfModule.ICollectionView<T>, selfModule.EventArgs>;
    /**
     ...
     * Occurs before the current item changes.
     */
    readonly currentChanging: selfModule.Event<selfModule.ICollectionView<T>, selfModule.CancelEventArgs>;
    /**
     ...
     * Occurs after the page index changes.
     */
    readonly pageChanged: selfModule.Event<selfModule.IPagedCollectionView, selfModule.EventArgs>;
    /**
     ...
     * Occurs before the page index changes.
     */
    readonly pageChanging: selfModule.Event<selfModule.IPagedCollectionView, selfModule.PageChangingEventArgs>;
    /**
...
export declare class Control extends ControlBase {
     ...
     */
    readonly gotFocus: selfModule.Event<selfModule.Control, selfModule.EventArgs>;
    /**
     ...
     */
    readonly lostFocus: selfModule.Event<selfModule.Control, selfModule.EventArgs>;
    /**
     ...
     */
    readonly invalidInput: selfModule.Event<selfModule.Control, selfModule.CancelEventArgs>;
    /**
     ...
     */
    readonly refreshing: selfModule.Event<selfModule.Control, selfModule.EventArgs>;
    /**
     ...
     */
    readonly refreshed: selfModule.Event<selfModule.Control, selfModule.EventArgs>;
    /**
...
export declare class Tooltip {
     ...
     */
    readonly popup: selfModule.Event<selfModule.Tooltip, selfModule.TooltipEventArgs>;
    /**
