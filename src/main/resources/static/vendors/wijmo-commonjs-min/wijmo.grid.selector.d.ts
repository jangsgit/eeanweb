...
import { Event, EventArgs, CancelEventArgs } from 'wijmo/wijmo';
import { FlexGrid, Column } from 'wijmo/wijmo.grid';
import * as selfModule from 'wijmo/wijmo.grid.selector';
/**
...
export declare class Selector {
     ...
     */
    readonly columnChanging: Event<selfModule.Selector, CancelEventArgs>;
    /**
     ...
     */
    readonly columnChanged: Event<selfModule.Selector, EventArgs>;
    /**
     ...
     */
    readonly itemChecked: Event<selfModule.Selector, EventArgs>;
    /**
