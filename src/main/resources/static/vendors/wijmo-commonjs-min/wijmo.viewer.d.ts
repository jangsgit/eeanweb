...
import { EventArgs, Event, Control, IEventHandler, Point, Rect } from 'wijmo/wijmo';
import { Popup, Menu } from 'wijmo/wijmo.input';
import * as selfModule from 'wijmo/wijmo.viewer';
export declare class _MultiSelectEx {
    ...
    private _lostFocus;
    readonly checkedItemsChanged: Event<selfModule._MultiSelectEx, EventArgs>;
...
export declare class _ParametersEditor extends Control {
    ...
    readonly commit: Event<selfModule._ParametersEditor, EventArgs>;
    readonly validate: Event<selfModule._ParametersEditor, EventArgs>;
...
export declare class _TouchTrigger {
    ...
    touchMove: selfModule._TouchEvent;
    touchStart: selfModule._TouchEvent;
    touchEnd: selfModule._TouchEvent;
...
export declare class _PanEventArgs extends _TouchEventArgs {
    ...
    readonly type: selfModule._TouchEventType;
...
export declare class _PanTrigger extends _TouchTrigger {
    ...
    panMove: selfModule._PanEvent;
    panStart: selfModule._PanEvent;
    panEnd: selfModule._PanEvent;
...
export declare class _VScroller extends _Scroller {
    ...
    constructor(element: any);
    readonly valueChanged: Event<selfModule._VScroller, EventArgs>;
    onValueChanged(): void;
...
export declare class _HistoryManager {
    private _items;
    private _position;
    readonly statusChanged: Event<selfModule._HistoryManager, EventArgs>;
...
export declare class _DocumentSource {
    ...
    private _httpHandler;
    readonly pageCountChanged: Event<selfModule._DocumentSource, EventArgs>;
    readonly disposed: Event<selfModule._DocumentSource, EventArgs>;
    readonly pageSettingsChanged: Event<selfModule._DocumentSource, EventArgs>;
    readonly loading: Event<selfModule._DocumentSource, EventArgs>;
    readonly loadCompleted: Event<selfModule._DocumentSource, EventArgs>;
    readonly queryLoadingData: Event<selfModule._DocumentSource, selfModule.QueryLoadingDataEventArgs>;
...
export declare class _ReportSourceBase extends _DocumentSource {
    private _status;
    constructor(options: _IDocumentOptions, httpHandler: IHttpRequestHandler);
    readonly statusChanged: Event<selfModule._ReportSourceBase, EventArgs>;
...
export declare class _SearchManager {
    ...
    readonly currentChanged: Event<selfModule._SearchManager, EventArgs>;
    readonly searchStarted: Event<selfModule._SearchManager, EventArgs>;
    readonly searchCompleted: Event<selfModule._SearchManager, EventArgs>;
    readonly resultsCleared: Event<selfModule._SearchManager, EventArgs>;
    readonly textChanged: Event<selfModule._SearchManager, EventArgs>;
...
export declare class _Page {
    ...
    readonly linkClicked: Event<selfModule._Page, EventArgs>;
...
export declare class _PageViewBase extends Control implements _IPageView {
    ...
    readonly pageIndexChanged: Event<selfModule._PageViewBase, EventArgs>;
    readonly zoomFactorChanged: Event<selfModule._PageViewBase, EventArgs>;
    readonly zoomModeChanged: Event<selfModule._PageViewBase, EventArgs>;
    readonly positionChanged: Event<selfModule._PageViewBase, EventArgs>;
    readonly rotateAngleChanged: Event<selfModule._PageViewBase, EventArgs>;
    readonly pageLoaded: Event<selfModule._PageViewBase, EventArgs>;
    _init(): void;
    dispose(): void;
...
export declare class _CompositePageView extends Control implements _IPageView {
    ...
    static controlTemplate: string;
    constructor(element: any);
    readonly pageIndexChanged: Event<selfModule._CompositePageView, EventArgs>;
    readonly zoomFactorChanged: Event<selfModule._CompositePageView, EventArgs>;
    readonly zoomModeChanged: Event<selfModule._CompositePageView, EventArgs>;
    readonly positionChanged: Event<selfModule._CompositePageView, EventArgs>;
    readonly rotateAngleChanged: Event<selfModule._CompositePageView, EventArgs>;
    readonly pageLoaded: Event<selfModule._CompositePageView, EventArgs>;
    applyTemplate(css: string, tpl: string, parts: Object): HTMLElement;
    readonly pageIndex: number;
    pages: _Page[];
    zoomMode: ZoomMode;
...
export declare class _Toolbar extends Control {
    ...
    svgButtonClicked: Event<selfModule._Toolbar, selfModule._IToolbarSvgButtonClickedEventArgs>;
...
export declare class _SideTabs extends Control {
    ...
    private _tabPages;
    private _tabPageDic;
    readonly tabPageActived: Event<selfModule._SideTabs, EventArgs>;
    readonly tabPageVisibilityChanged: Event<selfModule._SideTabs, EventArgs>;
    readonly expanded: Event<selfModule._SideTabs, EventArgs>;
    readonly collapsed: Event<selfModule._SideTabs, EventArgs>;
...
export declare class _PageSetupDialog extends Popup {
    ...
    private _gHeader;
    readonly applied: Event<selfModule._PageSetupDialog, EventArgs>;
    static controlTemplate: string;
    constructor(ele: any);
    readonly pageSettings: _IPageSettings;
    private _globalize;
...
export declare class _MouseTool extends Control {
    ...
    readonly pageView: selfModule._IPageView;
...
export declare class _Rubberband extends _MouseTool {
    readonly applied: Event<selfModule._Rubberband, selfModule._RubberbandOnAppliedEventArgs>;
...
export declare class ViewerBase extends Control implements IHttpRequestHandler {
     ...
     */
    static controlTemplate: string;
    readonly _documentSourceChanged: Event<selfModule.ViewerBase, EventArgs>;
    /**
     * Occurs after the page index is changed.
     */
    readonly pageIndexChanged: Event<selfModule.ViewerBase, EventArgs>;
    /**
     * Occurs after the view mode is changed.
     */
    readonly viewModeChanged: Event<selfModule.ViewerBase, EventArgs>;
    /**
     * Occurs after the mouse mode is changed.
     */
    readonly mouseModeChanged: Event<selfModule.ViewerBase, EventArgs>;
    /**
     * Occurs after the full screen mode is changed.
     */
    readonly fullScreenChanged: Event<selfModule.ViewerBase, EventArgs>;
    /**
     * Occurs after the zoom factor is changed.
     */
    readonly zoomFactorChanged: Event<selfModule.ViewerBase, selfModule._IZoomFactorChangedEventArgs>;
    /**
     * Occurs after the zoom mode is changed.
     */
    readonly zoomModeChanged: Event<selfModule.ViewerBase, selfModule._IZoomModeChangedEventArgs>;
    /**
     * Occurs when querying the request data sent to the service before loading the document.
     */
    readonly queryLoadingData: Event<selfModule.ViewerBase, selfModule.QueryLoadingDataEventArgs>;
    /**
     ...
     * will be null.
     */
    readonly beforeSendRequest: Event<selfModule.ViewerBase, selfModule.RequestEventArgs>;
    /**
     * Occurs when the next page has been loaded from the server, and its SVG has been rendered.
     */
    readonly pageLoaded: Event<selfModule.ViewerBase, selfModule.PageLoadedEventArgs>;
    /**
    ...
    readonly _viewerActionStatusChanged: Event<selfModule.ViewerBase, EventArgs>;
 ...
 * ```typescript
 * import { PdfViewer } from 'wijmo/wijmo.viewer';
 ...
 * ```typescript
 * import { ReportViewer } from 'wijmo/wijmo.viewer';
...
export declare class ReportViewer extends ViewerBase {
    ...
    */
    ...
    _createPage(index: number, defPageSize: _ISize): selfModule._Page;
    protected _actionElementClicked(element: SVGElement): void;
    protected _getActionInfo(element: SVGElement): _IDocAction;
}
