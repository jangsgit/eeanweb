...
import { Point, Event, EventArgs } from 'wijmo/wijmo';
import { FlexChartCore } from 'wijmo/wijmo.chart';
import * as selfModule from 'wijmo/wijmo.chart.interaction';
/**
...
export declare class _RangeSlider {
    ...
    */
    readonly rangeChanged: Event<selfModule._RangeSlider, EventArgs>;
    /**
    ...
    */
    readonly rangeChanging: Event<selfModule._RangeSlider, EventArgs>;
    /**
...
export declare class RangeSelector {
     ...
     * Occurs after the range changes.
     */
    rangeChanged: Event<selfModule.RangeSelector, EventArgs>;
    /**
     * Raises the {@link rangeChanged} event.
     */
    onRangeChanged(e?: EventArgs): void;
