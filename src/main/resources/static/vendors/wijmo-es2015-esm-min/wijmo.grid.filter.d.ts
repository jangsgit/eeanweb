...
import { Column, DataMap, FlexGrid, HitTestInfo, CellRangeEventArgs } from 'wijmo/wijmo.grid';
import { Control, Event, EventArgs } from 'wijmo/wijmo';
import * as selfModule from 'wijmo/wijmo.grid.filter';
/**
...
export declare class FlexGridFilter {
     ...
     */
    readonly filterApplied: Event<selfModule.FlexGridFilter, EventArgs>;
    /**
     ...
     * ```
     */
    readonly editingFilter: Event<selfModule.FlexGridFilter, EventArgs>;
    /**
     ...
     * ```
     */
    readonly filterChanging: Event<selfModule.FlexGridFilter, CellRangeEventArgs>;
    /**
     ...
     */
    readonly filterChanged: Event<selfModule.FlexGridFilter, CellRangeEventArgs>;
    /**
...
export declare class ConditionFilterEditor extends Control {
     ...
     */
    readonly canApplyChanged: Event<selfModule.ConditionFilterEditor, EventArgs>;
    /**
...
export declare class ValueFilterEditor extends Control {
     ...
     * Occurs when the value of the {@linj canApply} property changes.
     */
    readonly canApplyChanged: Event<selfModule.ValueFilterEditor, EventArgs>;
    /**
     * Raises the {@link canApplyChanged} event.
     */
    onCanApplyChanged(e?: EventArgs): void;
...
export declare class ColumnFilterEditor extends Control {
     ...
     */
    readonly filterChanged: Event<selfModule.ColumnFilterEditor, EventArgs>;
    /**
     * Raises the {@link filterChanged} event.
     */
     ...
     */
    readonly buttonClicked: Event<selfModule.ColumnFilterEditor, EventArgs>;
    /**
