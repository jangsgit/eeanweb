...
import { CancelEventArgs, Control, Event, EventArgs } from 'wijmo/wijmo';
...
import * as selfModule from 'wijmo/wijmo.undo';
/**
...
export declare class UndoStack {
     ...
     */
    readonly addingTarget: Event<selfModule.UndoStack, selfModule.AddTargetEventArgs>;
    /**
     ...
     */
    readonly addedTarget: Event<selfModule.UndoStack, selfModule.AddTargetEventArgs>;
    /**
     ...
     */
    readonly addingAction: Event<selfModule.UndoStack, selfModule.UndoActionEventArgs>;
    /**
     ...
     */
    readonly addedAction: Event<selfModule.UndoStack, selfModule.UndoActionEventArgs>;
    /**
     ...
     */
    readonly undoingAction: Event<selfModule.UndoStack, selfModule.UndoActionEventArgs>;
    /**
     ...
     * @param e {@link UndoActionEventArgs} that contains the event data.
     */
    readonly undoneAction: Event<selfModule.UndoStack, selfModule.UndoActionEventArgs>;
    /**
     ...
     */
    readonly redoingAction: Event<selfModule.UndoStack, selfModule.UndoActionEventArgs>;
    /**
     ...
     * @param e {@link UndoActionEventArgs} that contains the event data.
     */
    readonly redoneAction: Event<selfModule.UndoStack, selfModule.UndoActionEventArgs>;
    /**
     ...
     */
    readonly stateChanged: Event<selfModule.UndoStack, EventArgs>;
    /**
