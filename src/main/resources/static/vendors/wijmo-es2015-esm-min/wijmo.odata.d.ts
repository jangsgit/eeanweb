...
import { Event, EventArgs, RequestErrorEventArgs, CollectionView, PageChangingEventArgs } from 'wijmo/wijmo';
import * as mGrid from 'wijmo/wijmo.grid';
import * as mFilter from 'wijmo/wijmo.grid.filter';
import * as selfModule from 'wijmo/wijmo.odata';
...
export declare class ODataCollectionView extends CollectionView {
     ...
     */
    readonly loading: Event<selfModule.ODataCollectionView, EventArgs>;
    /**
     ...
     */
    readonly loaded: Event<selfModule.ODataCollectionView, EventArgs>;
    /**
     ...
     */
    readonly error: Event<selfModule.ODataCollectionView, RequestErrorEventArgs>;
    /**
     ...
     */
    readonly hasPendingChangesChanged: Event<selfModule.ODataCollectionView, EventArgs>;
    /**
