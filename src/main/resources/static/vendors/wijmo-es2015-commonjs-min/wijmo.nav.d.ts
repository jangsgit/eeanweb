...
import { Binding, EventArgs, CancelEventArgs, Control, Event, ObservableArray } from 'wijmo/wijmo';
import * as selfModule from 'wijmo/wijmo.nav';
/**
...
export declare class TabPanel extends Control {
     ...
     */
    readonly selectedIndexChanged: Event<selfModule.TabPanel, EventArgs>;
    /**
...
export declare class Accordion extends Control {
     ...
     * Occurs when the value of the {@link selectedIndex} property changes.
     */
    readonly selectedIndexChanged: Event<selfModule.Accordion, EventArgs>;
    /**
     * Raises the {@link selectedIndexChanged} event.
     */
    onSelectedIndexChanged(e?: EventArgs): void;
...
export declare class TreeView extends Control {
    ...
    private _items;
    _selNode: TreeNode;
    _itmPath: selfModule._BindingArray;
    _chkPath: selfModule._BindingArray;
    private _prevSel;
    private _dspPath;
    private _imgPath;
    private _dd;
     ...
     *
     * ```typescript
     * import { TreeView } from 'wijmo/wijmo.nav';
     ...
     */
    readonly itemsSourceChanged: Event<selfModule.TreeView, EventArgs>;
    /**
     ...
     */
    readonly loadingItems: Event<selfModule.TreeView, CancelEventArgs>;
    /**
     ...
     */
    readonly loadedItems: Event<selfModule.TreeView, EventArgs>;
    /**
     ...
     */
    readonly itemClicked: Event<selfModule.TreeView, EventArgs>;
    /**
     ...
     */
    readonly selectedItemChanged: Event<selfModule.TreeView, EventArgs>;
    /**
     ...
     * properties.
     */
    readonly checkedItemsChanged: Event<selfModule.TreeView, EventArgs>;
    /**
     ...
     */
    readonly isCollapsedChanging: Event<selfModule.TreeView, selfModule.TreeNodeEventArgs>;
    /**
     ...
     */
    readonly isCollapsedChanged: Event<selfModule.TreeView, selfModule.TreeNodeEventArgs>;
    /**
     ...
     */
    readonly isCheckedChanging: Event<selfModule.TreeView, selfModule.TreeNodeEventArgs>;
    /**
     ...
     */
    readonly isCheckedChanged: Event<selfModule.TreeView, selfModule.TreeNodeEventArgs>;
    /**
     ...
     * ```
     */
    readonly formatItem: Event<selfModule.TreeView, selfModule.FormatNodeEventArgs>;
    /**
     ...
     */
    readonly dragStart: Event<selfModule.TreeView, selfModule.TreeNodeEventArgs>;
    /**
     ...
     */
    readonly dragOver: Event<selfModule.TreeView, selfModule.TreeNodeDragDropEventArgs>;
    /**
     ...
     * @return True if the event was not canceled.
     */
    readonly drop: Event<selfModule.TreeView, selfModule.TreeNodeDragDropEventArgs>;
    /**
     ...
     * or keyboard.
     */
    readonly dragEnd: Event<selfModule.TreeView, EventArgs>;
    /**
     ...
     */
    readonly nodeEditStarting: Event<selfModule.TreeView, selfModule.TreeNodeEventArgs>;
    /**
    ...
    */
     ...
     */
    readonly nodeEditStarted: Event<selfModule.TreeView, selfModule.TreeNodeEventArgs>;
    /**
     ...
     */
    readonly nodeEditEnding: Event<selfModule.TreeView, selfModule.TreeNodeEventArgs>;
    /**
     ...
     */
    readonly nodeEditEnded: Event<selfModule.TreeView, selfModule.TreeNodeEventArgs>;
    /**
