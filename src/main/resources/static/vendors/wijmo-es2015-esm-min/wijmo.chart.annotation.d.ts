...
import { Size, Point, ObservableArray } from 'wijmo/wijmo';
import { DataPoint, IRenderEngine, Axis, FlexChartCore } from 'wijmo/wijmo.chart';
/**
...
export declare class AnnotationLayer {
    ...
    _renderGroup(): void;
    _renderAnnotation(engine: IRenderEngine, item: AnnotationBase): void;
