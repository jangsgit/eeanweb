 ...
 *
 * ```typescript
 * import { PdfDocument, saveBlob } from 'wijmo/wijmo.pdf';
 * import 'wijmo/wijmo.pdf.security';
 *
...
import * as selfModule from 'wijmo/wijmo.pdf.security';
...
export declare class _PDFSecurity {
    ...
    static create(document: any, options?: any): selfModule._PDFSecurity;
    private document;
    private version;
    private dictionary;
    private keyBits;
