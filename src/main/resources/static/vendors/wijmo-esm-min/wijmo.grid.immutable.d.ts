...
import { CollectionView, Event, EventArgs } from 'wijmo/wijmo';
import { FlexGrid } from 'wijmo/wijmo.grid';
import * as selfModule from 'wijmo/wijmo.grid.immutable';
/**
 ...
 * ```typescript
 *   import { ImmutabilityProvider, DataChangeEventArgs, DataChangeAction } from 'wijmo/wijmo.grid.immutable';
 *   import { FlexGrid } from 'wijmo/wijmo.grid';
...
export declare class ImmutabilityProvider {
     ...
     */
    readonly dataChanged: Event<FlexGrid, selfModule.DataChangeEventArgs>;
    /**
     ...
     */
    readonly cloningItem: Event<FlexGrid, selfModule.CloningItemEventArgs>;
    /**
